...
export const Hero = ({
  ...
  return <section id="start" className="relative min-h-[80vh] sm:min-h-[85vh] flex items-center justify-center overflow-hidden pt-14 sm:pt-16">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative mb-8 sm:mb-12 md:mb-16 flex justify-center animate-blur-to-sharp">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              ...
              <div
                className="absolute w-[500px] h-[500px] md:w-[650px] md:h-[650px] rounded-full blur-[120px] animate-pulse-glow hidden sm:block"
                style={{
                  background: 'radial-gradient(circle, rgba(34,197,94,0.35) 0%, rgba(59,130,246,0.25) 50%, transparent 70%)',
              ...
              <div
                className="absolute w-[350px] h-[350px] sm:w-[420px] sm:h-[420px] md:w-[550px] md:h-[550px] rounded-full blur-[70px] sm:blur-[80px] animate-halo-glow"
                style={{
                  background: `conic-gradient(
                    from 180deg at 50% 55%,
                    rgba(34, 197, 94, 0.5) 0deg,
                    rgba(34, 197, 94, 0.45) 45deg,
                    rgba(47, 163, 107, 0.42) 90deg,
                    rgba(59, 130, 246, 0.42) 135deg,
                    rgba(59, 130, 246, 0.5) 180deg,
                    rgba(59, 130, 246, 0.45) 225deg,
                    rgba(47, 163, 107, 0.42) 270deg,
                    rgba(34, 197, 94, 0.42) 315deg,
            ...
            transition: isHovering ? 'none' : 'transform 0.5s ease-out'
              ...
              {/* Inner glow on hover */}
              <div className="absolute inset-[2px] sm:inset-[3px] rounded-[40px] sm:rounded-[60px] md:rounded-[70px] opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-4 sm:mb-6 leading-tight px-2 tracking-tight animate-blur-to-sharp" style={{ animationDelay: '0.15s' }}>
          ...
          {/* Subtitle */}
          <p className="text-base sm:text-lg md:text-xl text-foreground/80 mb-6 sm:mb-8 max-w-2xl mx-auto px-4 animate-blur-to-sharp" style={{ animationDelay: '0.3s' }}>
            {t.hero_subtitle}
          </p>

          {/* CTA Buttons - Touch-friendly on mobile */}
          <div className="flex flex-col gap-3 justify-center items-center px-4 animate-blur-to-sharp" style={{ animationDelay: '0.45s' }}>
