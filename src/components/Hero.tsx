    ...
    <section id="start" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto text-center">
          {/* Logo with Glow Effect - App Style Square Container */}
          <div className="relative mb-16 flex justify-center">
            {/* Wide Soft Glow Behind Square Container */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-[500px] h-[450px] sm:w-[600px] sm:h-[550px]">
                {/* Veritas Glow (Left/Green) */}
                <div 
                  className="absolute left-0 top-1/2 -translate-y-1/2 w-[350px] h-[350px] sm:w-[450px] sm:h-[450px] rounded-full blur-[120px] opacity-70"
                  style={{
                ...
                <div 
                  className="absolute right-0 top-1/2 -translate-y-1/2 w-[350px] h-[350px] sm:w-[450px] sm:h-[450px] rounded-full blur-[120px] opacity-70"
                  style={{
            ...
            {/* Perfect Square Container - App Style */}
            <div className="relative z-10 bg-[#0f1419] rounded-[52px] p-8 sm:p-10 shadow-2xl aspect-square flex items-center justify-center w-[280px] sm:w-[340px]">
              {/* ForRealScan Master Logo - Centered, No Extra Padding */}
              <img 
                src={logoMaster} 
