...
export const translations = {
  de: {
    ...
    pricing_free_feat1: 'V3 Standard Scan',
    pricing_free_feat2: 'Werbung möglich',
    pricing_free_feat3: 'Begrenzte Scans/Tag',
    pricing_free_feat4: 'Limitierte V5 Scans (3/Tag)',
    pricing_free_cta: 'Kostenlos starten',
    
    pricing_premium_title: 'Premium',
    pricing_premium_price: 'ab 9,99 €/Monat',
    pricing_premium_feat1: 'Unbegrenzte V3 Scans',
    pricing_premium_feat2: 'Unbegrenzte V5 UltraDeepScans',
    pricing_premium_feat3: 'Werbefrei',
    pricing_premium_feat4: 'Prioritäts-Verarbeitung',
    pricing_premium_feat5: 'Erweiterte Historie',
    pricing_premium_cta: 'Premium freischalten',
  ...
  en: {
    ...
    pricing_free_feat1: 'V3 Standard Scan',
    pricing_free_feat2: 'Ads possible',
    pricing_free_feat3: 'Limited scans/day',
    pricing_free_feat4: 'Limited V5 scans (3/day)',
    pricing_free_cta: 'Start Free',
    
    pricing_premium_title: 'Premium',
    pricing_premium_price: 'from $9.99/month',
    pricing_premium_feat1: 'Unlimited V3 scans',
    pricing_premium_feat2: 'Unlimited V5 UltraDeepScans',
    pricing_premium_feat3: 'Ad-free',
    pricing_premium_feat4: 'Priority processing',
    pricing_premium_feat5: 'Extended history',
    pricing_premium_cta: 'Unlock Premium',
  ...
  it: {
    ...
    pricing_free_feat1: 'V3 Standard Scan',
    pricing_free_feat2: 'Pubblicità possibile',
    pricing_free_feat3: 'Scansioni limitate/giorno',
    pricing_free_feat4: 'Scansioni V5 limitate (3/giorno)',
    pricing_free_cta: 'Inizia Gratis',
    
    pricing_premium_title: 'Premium',
    pricing_premium_price: 'da 9,99 €/mese',
    pricing_premium_feat1: 'Scansioni V3 illimitate',
    pricing_premium_feat2: 'UltraDeepScan V5 illimitati',
    pricing_premium_feat3: 'Senza pubblicità',
    pricing_premium_feat4: 'Elaborazione prioritaria',
    pricing_premium_feat5: 'Cronologia estesa',
    pricing_premium_cta: 'Sblocca Premium',
  ...
  es: {
    ...
    pricing_free_feat1: 'V3 Escaneo Estándar',
    pricing_free_feat2: 'Anuncios posibles',
    pricing_free_feat3: 'Escaneos limitados/día',
    pricing_free_feat4: 'Escaneos V5 limitados (3/día)',
    pricing_free_cta: 'Comenzar Gratis',
    
    pricing_premium_title: 'Premium',
    pricing_premium_price: 'desde 9,99 €/mes',
    pricing_premium_feat1: 'Escaneos V3 ilimitados',
    pricing_premium_feat2: 'UltraDeepScans V5 ilimitados',
    pricing_premium_feat3: 'Sin anuncios',
    pricing_premium_feat4: 'Procesamiento prioritario',
    pricing_premium_feat5: 'Historial extendido',
    pricing_premium_cta: 'Desbloquear Premium',
