...
export const translations: Record<Language, Translations> = {
  de: {
    ...
    methodology_mode_image_method: 'Forensische Bildanalyse + Vision',
  ...
  en: {
    ...
    methodology_mode_image_method: 'Forensic image analysis + Vision',
    methodology_mode_image_credits: '1 Credit',
  ...
  it: {
    ...
    methodology_mode_image_method: 'Analisi forense + Vision',
  ...
  es: {
    ...
    methodology_mode_image_method: 'Análisis forense + Vision',
  ...
  fr: {
    ...
    methodology_mode_image_method: 'Analyse forensique + Vision',
