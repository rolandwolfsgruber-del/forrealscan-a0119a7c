...
const aboutTranslations: Record<Language, {
  ...
  de: {
    ...
    tech_p1: 'ForRealScan nutzt einen dualen Ansatz mit zwei spezialisierten Analysesystemen: "Veritas" für technische Bildanalyse und "Robo" für KI-basierte Mustererkennung. Diese Kombination ermöglicht eine umfassendere Einschätzung als einzelne Methoden allein.',
  ...
  en: {
    ...
    tech_p1: 'ForRealScan uses a dual approach with two specialized analysis systems: "Veritas" for technical image analysis and "Robo" for AI-based pattern recognition. This combination enables a more comprehensive assessment than individual methods alone.',
  ...
  it: {
    ...
    tech_p1: 'ForRealScan utilizza un approccio duale con due sistemi di analisi specializzati: "Veritas" per l\'analisi tecnica delle immagini e "Robo" per il riconoscimento di pattern basato su IA. Questa combinazione consente una valutazione più completa rispetto ai singoli metodi.',
  ...
  es: {
    ...
    tech_p1: 'ForRealScan utiliza un enfoque dual con dos sistemas de análisis especializados: "Veritas" para análisis técnico de imágenes y "Robo" para reconocimiento de patrones basado en IA. Esta combinación permite una evaluación más completa que los métodos individuales.',
  ...
  fr: {
    ...
    tech_p1: 'ForRealScan utilise une approche duale avec deux systèmes d\'analyse spécialisés : "Veritas" pour l\'analyse technique des images et "Robo" pour la reconnaissance de motifs basée sur l\'IA. Cette combinaison permet une évaluation plus complète que les méthodes individuelles.',
